...
CREATE TABLE IF NOT EXISTS `bandeijao`.`usuario` (
  ...
  INDEX `fk_usuario_curso_idx` (`curso_id_curso` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bandeijao`.`pedido` (
  ...
  INDEX `fk_pedido_usuario1_idx` (`usuario_cpf` ASC, `usuario_curso_id_curso` ASC) VISIBLE,
  INDEX `fk_pedido_cardapio1_idx` (`cardapio_id_cardapio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bandeijao`.`usuario_has_restricao_alimentar` (
  ...
  INDEX `fk_usuario_has_restricao_alimentar_restricao_alimentar1_idx` (`restricao_alimentar_id_restricao` ASC) VISIBLE,
  INDEX `fk_usuario_has_restricao_alimentar_usuario1_idx` (`usuario_cpf` ASC, `usuario_curso_id_curso` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bandeijao`.`cardapio_has_alimento` (
  ...
  INDEX `fk_cardapio_has_alimento_alimento1_idx` (`alimento_id_alimento` ASC) VISIBLE,
  INDEX `fk_cardapio_has_alimento_cardapio1_idx` (`cardapio_id_cardapio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bandeijao`.`mensagem` (
  ...
  INDEX `fk_Mensagem_usuario1_idx` (`usuario_cpf` ASC, `usuario_curso_id_curso` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `bandeijao`.`pedido_has_alimento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bandeijao`.`pedido_has_alimento` (
  `pedido_id_pedido` INT NOT NULL,
  `pedido_usuario_cpf` VARCHAR(11) NOT NULL,
  `pedido_usuario_curso_id_curso` INT NOT NULL,
  `pedido_cardapio_id_cardapio` INT NOT NULL,
  `alimento_id_alimento` INT NOT NULL,
  PRIMARY KEY (`pedido_id_pedido`, `pedido_usuario_cpf`, `pedido_usuario_curso_id_curso`, `pedido_cardapio_id_cardapio`, `alimento_id_alimento`),
  INDEX `fk_pedido_has_alimento_alimento1_idx` (`alimento_id_alimento` ASC) VISIBLE,
  INDEX `fk_pedido_has_alimento_pedido1_idx` (`pedido_id_pedido` ASC, `pedido_usuario_cpf` ASC, `pedido_usuario_curso_id_curso` ASC, `pedido_cardapio_id_cardapio` ASC) VISIBLE,
  CONSTRAINT `fk_pedido_has_alimento_pedido1`
    FOREIGN KEY (`pedido_id_pedido` , `pedido_usuario_cpf` , `pedido_usuario_curso_id_curso` , `pedido_cardapio_id_cardapio`)
    REFERENCES `bandeijao`.`pedido` (`id_pedido` , `usuario_cpf` , `usuario_curso_id_curso` , `cardapio_id_cardapio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pedido_has_alimento_alimento1`
    FOREIGN KEY (`alimento_id_alimento`)
    REFERENCES `bandeijao`.`alimento` (`id_alimento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
